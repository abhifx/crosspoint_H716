...
constexpr BoardProfile LILYGO_T5_H716 = {
    ...
    {PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED,
     PIN_UNASSIGNED},
    0,
    {11, 16, 15, 42, PIN_UNASSIGNED, false, 0},  // SD: SCLK11 MISO16 MOSI15 CS42
    {PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, PIN_UNASSIGNED, 21,
     false},
    9,  // batteryAdc: GPIO 9 for H716 Standard
    PIN_UNASSIGNED,
    2.0f,
    PIN_UNASSIGNED, // usbDetect
    // GT911 touch (SDA18 SCL17 INT47, 0x5D). Portrait sensor on landscape panel.
    {TouchController::Gt911, 18, 17, 47, PIN_UNASSIGNED, 0x5D, 0, 959, 0, 539, false, 0x14, false, true, PIN_UNASSIGNED, true, false, true},
    NO_FRONTLIGHT,
    NO_AUDIO,
    NO_LEDS,
    NO_FLIP,
    NO_SDMMC,
    {18, 17, 400000, 0, 0x6B}, // BQ25896 charger (0x6B) on SDA18/SCL17; no gauge IC
    NO_MIC,
    {18, 17, 400000, 0x51, 0, 0, 0, RtcType::Pcf8563, ImuType::None}, // RTC (0x51) on 18/17
    1.2f,
    {2}}; // Power latch on GPIO 2
...
constexpr uint32_t MAX_FRAMEBUFFER_BYTES = cmax(
    ...
    cmax(cmax(cmax(FREEINK_DEVICE_DELINK ? panelBytes(DE_LINK) : 0u,
                   (FREEINK_DEVICE_LILYGO || FREEINK_DEVICE_LILYGO_H716) ? panelBytes(LILYGO_T5S3) : 0u),
