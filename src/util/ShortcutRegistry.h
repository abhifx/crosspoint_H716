...
inline const std::array<ShortcutDefinition, 21>& getShortcutDefinitions() {
  static const std::array<ShortcutDefinition, 21> definitions = {
      ...
      ShortcutDefinition{ShortcutId::SyncDay, StrId::STR_SYNC_DAY, StrId::STR_SYNC_DAY_DESC, UIIcon::CalendarTime,
      ...
      ShortcutDefinition{ShortcutId::ReadingStats, StrId::STR_READING_STATS, StrId::STR_READING_STATS_DESC,
                         UIIcon::ReadingStatsIcon, &CrossPointSettings::readingStatsShortcut,
      ...
      ShortcutDefinition{ShortcutId::ReadingProfile, StrId::STR_READING_PROFILE, StrId::STR_READING_PROFILE_DESC,
                         UIIcon::ReadingProfile, &CrossPointSettings::readingProfileShortcut,
      ...
      ShortcutDefinition{ShortcutId::IfFound, StrId::STR_IF_FOUND_RETURN_ME, StrId::STR_IF_FOUND_APP_DESC, UIIcon::GpsFound,
      ...
      ShortcutDefinition{ShortcutId::RecentBooks, StrId::STR_MENU_RECENT_BOOKS, StrId::STR_RECENT_BOOKS_APP_DESC,
                         UIIcon::RecentBooks, &CrossPointSettings::recentBooksShortcut,
      ...
      ShortcutDefinition{ShortcutId::Flashcards, StrId::STR_FLASHCARDS, StrId::STR_FLASHCARDS_APP_DESC, UIIcon::FlashcardQuiz,
      ...
      ShortcutDefinition{ShortcutId::Dictionary, StrId::STR_DICTIONARY, StrId::STR_DICTIONARY_APP_DESC, UIIcon::Dictionary2,
      ...
      ShortcutDefinition{ShortcutId::FileTransfer, StrId::STR_FILE_TRANSFER, StrId::STR_FILE_TRANSFER_APP_DESC,
                         UIIcon::FileTransfer, &CrossPointSettings::fileTransferShortcut,
